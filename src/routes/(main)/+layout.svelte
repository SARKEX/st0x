...
{#if $vaultQuery.isLoading}
	<div class="flex justify-center items-center h-screen bg-gray-900">
		<div class="relative">
			<div class="absolute inset-0 rounded-full bg-gradient-to-r from-purple-700 via-blue-600 to-yellow-500 opacity-20 animate-pulse"></div>
			<div class="relative w-32 h-32 rounded-full border-4 border-transparent border-t-yellow-500 border-r-blue-600 border-b-purple-700 border-l-green-500 animate-spin"></div>
			<div class="absolute inset-0 flex items-center justify-center">
				<div class="w-24 h-24 rounded-full bg-gray-900"></div>
			</div>
		</div>
	</div>
