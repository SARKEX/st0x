						...
						<div class="flex-1">
							<div class="space-y-3 text-gray-300">
								{#each MINT_ISSUERS as issuer}
									<div class="group relative overflow-hidden rounded-xl border border-white/5 bg-gray-700/30 p-6 transition-all hover:border-yellow-500/30 hover:bg-gray-700/40">
										...
										<div class="absolute right-4 top-4 flex items-center gap-2">
											{#if deposit.id}
												<span
													...
													>Completed</span
												>
												<button class="info-button inline-block" aria-label="Show strategy information" on:click={() => {
