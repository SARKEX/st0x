	...
	<section class="px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
		<div class="mx-auto max-w-3xl">
			...
			<p class="mb-4 text-text-2">
				...
				follows from the data collection purposes listed above. Under no circumstances will we use
				the collected data for the purpose of drawing conclusions about your person. Furthermore,
				the lawfulness of the data collection follows from Art. 6 (1) (b) GDPR, if we provide you
				with the information on our website at the pre-contractual and, if necessary, already at a
				contractual stage. In addition, we use cookies and analysis services when you visit our
			...
			<p class="mb-4 text-text-2">
				...
				that a message always appears before saving whether a cookie is being created. If you
			...
			<p class="mb-4 text-text-2">
				...
				(Art. 6 (1) (f) GDPR) and, in the case of initiating a contract, Art. 6 (1) (b) GDPR. You
				are neither legally nor contractually obliged to provide us with this information. However,
			...
			<p class="mb-4 text-text-2">
				...
				information, location data, usage and interaction data and, if applicable, your public X
				profile (incl. username, picture, posts). According to X, the processing of user data from
				the European Economic Area takes place on servers in Ireland. Please note that data may also
				be processed by X outside the EU (e.g. USA). We have no direct influence on data processing
				by X. The use of this platform is at your own risk. Further information on data processing
			...
			<p class="mb-4 text-text-2">
				...
				contain the following data in particular: number of followers including growth over a
			...
			<p class="mb-4 text-text-2">
				...
				have registered for Telegram from the European Economic Area, the data processing takes
				place in data centers in the Netherlands, according to Telegram. However, we have no
				influence on the type, scope and purposes of data processing by Telegram. Please note that
			...
			<p class="mb-4 text-text-2">
				...
				If you contact us, the processing may also be justified due to a contractual relationship
				(Art. 6 (1) (b) GDPR). We only process and store your personal data for as long as necessary
				to fulfil our intentions, i.e. as long as we operate our company website or your actions on
				our website are active. In the case of consent, we process the data until you revoke this
				consent. Beyond this, the data will only be stored until the fulfilment of any statutory
				retention obligation. We have no influence on how and for how long the operators of the
				social media platforms store your data on the platform. For details, please refer to the
			...
			<p class="mb-4 text-text-2">
				...
				by us are obliged to comply with data protection standards within the framework of
				contractual obligations, unless they themselves are already obliged to comply with the
				requirements of the GDPR and other data protection regulations due to their own data
				protection responsibility. If it is necessary to transfer data to third countries outside
				the EU, this will only take place within the framework of a decision by the European
				Commission on the adequacy of the level of data protection offered by the third country.
				Data processing that goes beyond the aforementioned points and the transfer of data to third
				parties will only take place if you have given us your prior consent in accordance with Art.
				6 (1) (a) GDPR or if there is another reason in accordance with Art. 6 (1) lit. c) - f)
				GDPR.
			</p>
			...
			<p class="mb-4 text-text-2">
				...
				of your personal data be restricted (Art. 18 GDPR). Furthermore, you have the right to
				receive your personal data from the controller or to have it transferred to another
			...
			<p class="mb-4 text-text-2">
				...
				public interest) in accordance with Art. 21 (1) GDPR. We will then no longer process your
				personal data for these purposes, unless we can demonstrate compelling legitimate grounds
