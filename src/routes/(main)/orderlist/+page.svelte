...
<div>
	...
	<div class="space-y-6 sm:space-y-8 p-4 sm:p-6">
		<div class="mb-4 sm:mb-6 flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:gap-6">
			<input
			...
			/>
			<label class="flex items-center gap-2 text-white w-full sm:w-auto">
