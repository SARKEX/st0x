...
// TODO: TEMP - Using test USDC for testing, revert to 0x833589fcd6edb6e08f4c7c32d4f71b54bda02913 for production
...
export const TOKENS: CategorizedToken[] = [
	// TODO: TEMP - Test token for testing, remove for production
	{
		chainId: base.id,
