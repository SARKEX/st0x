...
export const TOKENS: CategorizedToken[] = [
	...
	},
	{
		...
		unwrappedAddress: '0x51D5C8C8040358686952A30fAC116aAC32390d6A',
		symbol: 'wtFTF',
		decimals: 18,
		name: 'Wrapped Franklin Limited Duration Income Trust ST0x',
		logoUrl: '/images/FTF.png',
		category: 'ST0x',
		tradingViewSymbol: 'AMEX:FTF',
		tradingViewMarket: 'america',
		limitOrders: []
	},
	{
		chainId: base.id,
		address: '0xB457cfBF31995d3aAAa704dA9999cC0b011820ca',
		unwrappedAddress: '0xBeB0c2011bd5520A0998b69132E9245E39Ac5D1D',
		symbol: 'wtCBRS',
		decimals: 18,
		name: 'Wrapped Cerebras Systems Inc. ST0x',
		logoUrl: '/images/CBRS.png',
		category: 'ST0x',
		tradingViewSymbol: 'NASDAQ:CBRS',
		tradingViewMarket: 'america',
		limitOrders: []
	},
	{
	...
	{
		chainId: base.id,
		address: '0xfae641bfE7009B5326396048b951E3aa31902a2B',
		unwrappedAddress: '0x07d7ca9384812b86e7E429473dF354fb59DA73A0',
		symbol: 'wtMBG.DE',
		decimals: 18,
		name: 'Wrapped Mercedes-Benz Group AG ST0x',
		logoUrl: '/images/MBG.DE.png',
		category: 'ST0x',
		tradingViewSymbol: 'XETR:MBG',
		tradingViewMarket: 'germany',
		limitOrders: []
	},
	{
		chainId: base.id,
		address: '0xD3c42aB4D5A60A50401b3A67D10B03Ce7D96DA19',
		unwrappedAddress: '0x725E0Df28D1EB09338f63776B76bCfc00f3b6f44',
		symbol: 'wtRHM.DE',
		decimals: 18,
		name: 'Wrapped Rheinmetall AG ST0x',
		logoUrl: '/images/RHM.DE.png',
		category: 'ST0x',
		tradingViewSymbol: 'XETR:RHM',
		tradingViewMarket: 'germany',
		limitOrders: []
	},
	{
	...
	{
		chainId: base.id,
		address: '0x761d56D1FE1E390A96A5ECf58dE69838A231A37c',
		unwrappedAddress: '0x47C04A6f705f755C10641E975607ecE8f18BC60c',
		symbol: 'wtGM',
		decimals: 18,
		name: 'Wrapped General Motors Company ST0x',
		logoUrl: '/images/GM.png',
		category: 'ST0x',
		tradingViewSymbol: 'NYSE:GM',
		tradingViewMarket: 'america',
		limitOrders: []
	},
	{
