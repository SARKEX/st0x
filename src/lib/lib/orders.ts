/**
 * On-chain Orderbook Operations
 *
 * This module consolidates all orderbook-related functionality:
 * - Quote fetching and processing from Raindex API
...
import { describeQuote, normalizeAddress, type MarketSide } from '$lib/lib/tokens';
...
// ============================================================================
// QUOTE PROCESSING & API INTEGRATION
// ============================================================================
