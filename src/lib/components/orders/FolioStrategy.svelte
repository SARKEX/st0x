<script lang="ts">
    ...
    $: disableDeploy = 
        overrideThresholdError || overrideFeeError || overrideDepositAmount1Error || overrideDepositAmount2Error || overrideDepositAmount3Error || overrideDepositAmount4Error || overrideDepositAmount5Error || overrideDepositAmount6Error || overrideDepositAmount7Error || inputVaultId1Error || inputVaultId2Error || inputVaultId3Error || inputVaultId4Error || inputVaultId5Error || inputVaultId6Error || inputVaultId7Error || outputVaultId1Error || outputVaultId2Error || outputVaultId3Error || outputVaultId4Error || outputVaultId5Error || outputVaultId6Error || outputVaultId7Error;
...
<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
    <div class="space-y-6 lg:col-span-2">
        ...
        <div class="space-y-4 rounded-lg border border-white/5 bg-gray-800/30 p-4">
            ...
            <div class="grid grid-cols-1 gap-4 mt-4 border-t border-white/10 pt-4">
        ...
        <div class="rounded-lg border border-white/10 bg-gray-700/30 p-4">
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium text-white">{formatUnits(overrideDepositAmount3 ?? 0n, selectedToken3.decimals)}</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-400">Token 4 Deposit Amount</span>
                    <span class="font-medium text-white">{formatUnits(overrideDepositAmount4 ?? 0n, selectedToken4.decimals)}</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-400">Token 5 Deposit Amount</span>
                    <span class="font-medium text-white">{formatUnits(overrideDepositAmount5 ?? 0n, selectedToken5.decimals)}</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-400">Token 6 Deposit Amount</span>
                    <span class="font-medium text-white">{formatUnits(overrideDepositAmount6 ?? 0n, selectedToken6.decimals)}</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-400">Token 7 Deposit Amount</span>
                    <span class="font-medium text-white">{formatUnits(overrideDepositAmount7 ?? 0n, selectedToken7.decimals)}</span>
                </div>
            </div>
        </div>

        <button
            class="w-full disabled:opacity-50 disabled:cursor-not-allowed rounded-lg bg-gradient-to-r from-blue-600 to-purple-700 px-6 py-3 font-semibold transition-transform hover:scale-105"
