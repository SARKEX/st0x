<script lang="ts">
	...
	import { validateBaseline, validateOverrideDepositAmount, validatePeriod, validateSelectedAmount } from '$lib/validateDeploymentArgs';
...
<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
    ...
    <div class="space-y-4">
        ...
        <div class="rounded-lg border border-white/10 bg-gray-700/30 p-4">
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium text-white">{formatUnits(selectedAmount ?? 0n, selectedOutputToken.decimals)} {selectedOutputToken.symbol}</span>
                </div>
                <div class="flex justify-between text-sm">
                ...
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium text-white">{formatUnits(overrideMinTradeAmount ?? 0n, selectedOutputToken.decimals)} {selectedOutputToken.symbol}</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-400">Maximum Trade Amount</span>
                    <span class="font-medium text-white">{formatUnits(overrideMaxTradeAmount ?? 0n, selectedOutputToken.decimals)} {selectedOutputToken.symbol}</span>
                </div>
                <div class="flex justify-between text-sm">
                ...
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium text-white"
                        >{formatUnits(depositAmount ?? 0n, selectedOutputToken.decimals)} {selectedOutputToken.symbol}</span
                    >
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-400">Min Trade Amount</span>
                    <span class="font-medium text-white"
                        >{formatUnits(minTradeAmount ?? 0n, selectedOutputToken.decimals)} {selectedOutputToken.symbol}</span
                    >
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-400">Max Trade Amount</span>
                    <span class="font-medium text-white"
                        >{formatUnits(maxTradeAmount ?? 0n, selectedOutputToken.decimals)} {selectedOutputToken.symbol}</span
                    >
                </div>
                <div class="flex justify-between text-sm">
        ...
        <button
            class="w-full rounded-lg bg-gradient-to-r from-blue-600 to-purple-700 px-6 py-3 font-semibold transition-transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
