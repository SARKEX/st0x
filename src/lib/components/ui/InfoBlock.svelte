...
<div class={
	...
	{#if variant === 'info'}
		<svg class={"mt-0.5 h-4 w-4 flex-shrink-0 sm:h-5 sm:w-5 " + variantConfig.iconClass} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="min-w-0 flex-1">
		{#if title}
			<div class={"font-medium " + variantConfig.titleClass}>
				{title}
			</div>
		{/if}
