<script lang="ts">
	...
	$: defaultDescription = description || 
		`Connect your wallet to access this feature on ${$currentNetwork?.displayName || 'this network'}.`;
</script>
		...
		<Section>
			<div class="flex flex-col items-center justify-center gap-6 px-6 py-12 sm:px-8 sm:py-16">
				<div class="rounded-full bg-gradient-to-br from-blue-600/20 to-purple-700/20 p-6">
					<svg class="h-10 w-10 text-blue-400 sm:h-12 sm:w-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
