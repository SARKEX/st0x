		...
		<Table class={tableStyles.container}>
			<thead>
				<tr class="border-b border-white/10">
					...
					<th class={tableStyles.headerCell}>Status</th>
					<th class={tableStyles.headerCell}>Order ID</th>
					<th class={tableStyles.headerCell}>Order Owner</th>
					<th class={tableStyles.headerCell}>Order Book</th>
					<th class={tableStyles.headerCell}>Last Updated</th>
					<th class={tableStyles.headerCell}>Buying</th>
					<th class={tableStyles.headerCell}>Selling</th>
				</tr>
			</thead>
			<tbody>
