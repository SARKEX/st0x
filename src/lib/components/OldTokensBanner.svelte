...
{#if showBanner}
	<div class="relative z-40 bg-brand-gold-600 px-4 py-2.5 text-center text-sm text-white">
		<div class="mx-auto flex max-w-4xl items-center justify-center gap-2">
			...
			<button
				...
				class="ml-1 font-semibold underline underline-offset-2 transition hover:text-brand-gold-100"
			>
				Click here to swap
			</button>
			<button
