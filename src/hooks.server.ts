...
//
// E2E test gate: relax connect-src to allow the in-browser EIP-1193 stub to reach
// anvil at http://127.0.0.1:8545. SET ONLY by tests/integration/ui/globalSetup.ts.
// NEVER set in Vercel production build, preview deploys, or any .env* file.
// See .planning/phases/01-ui-driven-e2e-order-test-coverage/01-RUNBOOK.md
