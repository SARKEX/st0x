...
const CSP_DIRECTIVES = [
	...
	"connect-src 'self' https://*.st0x.io https://*.vercel-kv.com https://*.vercel.app https://api.goldsky.com https://*.base.org https://*.publicnode.com https://*.llamarpc.com https://*.meowrpc.com https://*.blastapi.io https://gateway.tenderly.co https://*.alchemy.com https://*.tradingview.com https://*.walletconnect.com https://*.walletconnect.org https://api.web3modal.org https://*.web3modal.org wss://*.walletconnect.com wss://*.walletconnect.org https://js.hcaptcha.com https://hcaptcha.com https://*.hcaptcha.com https://api.dynamic.xyz https://*.dynamic.xyz https://app.dynamicauth.com https://*.dynamicauth.com https://dynamic-static-assets.com https://*.dynamic-static-assets.com https://rpc.ankr.com https://hermes.pyth.network https://*.pyth.network https://raw.githubusercontent.com https://api.openchain.xyz https://va.vercel-scripts.com https://assets.mailerlite.com https://tokens.coingecko.com https://*.coingecko.com https://cdn.jsdelivr.net https://*.posthog.com https://*.i.posthog.com https://*.merkle.io https://*.arbitrum.io https://mainnet.optimism.io https://rhinestone.dev https://*.rhinestone.dev https://rhinestone.xyz https://*.rhinestone.xyz https://rhinestone.io https://*.rhinestone.io https://rhinestone.com https://*.rhinestone.com wss://*.dynamic.xyz wss://*.dynamicauth.com wss://*.rhinestone.dev wss://*.rhinestone.xyz wss://*.rhinestone.io wss://*.rhinestone.com wss://metamask-sdk.api.cx.metamask.io https://metamask-sdk.api.cx.metamask.io",
