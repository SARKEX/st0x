...
function EarnHero({ openDeposit }) {
  const heroStats = [['$85B', 'BlackRock AUM'], ['<10s', 'Swap out · 24/7'], ['No KYC', 'Permissionless']];
  return (
    <section className="mx-auto max-w-5xl px-6 pt-12 pb-4">
      <div className="grid items-center gap-10 md:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <p className="mt-2.5 text-base font-semibold text-emerald-300 sm:text-lg">Treasury-backed. No KYC. Cash out anytime.</p>
          <p className="mt-4 max-w-md text-[15px] leading-relaxed text-gray-300">
            Turn idle USDC into <span className="font-semibold text-white">SGOV</span> — BlackRock’s US Treasury bill ETF, tokenised and live on Base. The only one you can hold in <span className="font-semibold text-emerald-300">any wallet</span> — and swap back to USDC whenever you want.
          </p>
      ...
      {/* Trust strip hidden for now — audit & prospectus content to be added later */}
    </section>
  );
}
    ...
    <section className="mx-auto max-w-5xl px-6 py-10">
      <div className="relative overflow-hidden rounded-2xl border border-emerald-400/25 bg-gradient-to-r from-emerald-500/[0.12] to-[#070b12] p-8 text-center">
        ...
        <div className="relative">
          ...
          <p className="mx-auto mt-2 max-w-md text-[15px] text-gray-300">Put it to work in 30 seconds. Earn {rate()}%, no KYC, cash out whenever.</p>
