        ...
        <div className="relative p-5">
          {step === 0 && (
            <div>
              ...
              <p className="mt-2 text-center text-[11px] text-gray-500">No KYC · no lockup · redeem to underlying anytime</p>
            </div>
          )}
          ...
          {step === 1 && (
            <div>
              ...
              <div className="mt-3 flex items-start gap-2 rounded-lg border border-white/[0.07] bg-white/[0.02] px-3 py-2.5 text-[11px] leading-relaxed text-gray-500">
                ...
                {recvSym} is tokenised SGOV (BlackRock’s T-bill ETF), not a bank deposit — very low risk but not FDIC-insured. Yield varies with rates.
              </div>
