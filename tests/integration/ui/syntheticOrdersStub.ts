...
//   2. `/api/st0x/v2/orders/query` REST API responses
//
 ...
 * /api/st0x/v2/orders/query endpoint returns. `ioRatio`, `maxOutput`, and
...
/**
 * Build a fully-synthetic /api/st0x/v2/orders/query response from the maker
